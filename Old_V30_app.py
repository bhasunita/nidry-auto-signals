...
<h1>📈 NIFTY Professional Signals V3.6</h1><div class="sub">5m + 15m confirmation • confidence scoring • option liquidity • trade alerts</div>
...
function renderLockedTrade(t,q=null){
 ...
 $("bias").textContent=isClosedTrade(t)?"LOCKED TRADE COMPLETE • RESET TO SCAN AGAIN":"LOCKED TRADE • LIVE P/L + SL/TARGET MONITORING • V3.6 QUALITY + REVERSAL + EOD CHECKS ACTIVE";
...
function render(d){
 ...
 $("dot").className="dot on";$("status").textContent="Connected • V3.6";$("error").textContent=d.warning||"";
 saveLastSignal(d);
