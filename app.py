...
<body>
<div class="wrap">
<h1>ðŸ“ˆ NIFTY Auto Signals</h1>
<div class="sub">No API key â€¢ 5-minute public data â€¢ auto refresh</div>
...
<div class="card">
  <div class="status">
    ...
    <span style="margin-left:auto" id="updated">â€”</span>
  </div>
  <div class="price" id="ltp">â€”</div>
  <div id="signal" class="signal neutral">WAITING</div>
  <div class="small" id="bias">Loading NIFTY 50â€¦</div>
  <div id="error"></div>
</div>

<div class="row">
  <div class="kpi"><div class="t">BUY ABOVE</div><div class="v" id="buyAbove">â€”</div></div>
  <div class="kpi"><div class="t">SELL BELOW</div><div class="v" id="sellBelow">â€”</div></div>
</div>

<div style="height:8px"></div>

<div class="row3">
  <div class="kpi"><div class="t">STOP LOSS</div><div class="v" id="sl">â€”</div></div>
  <div class="kpi"><div class="t">TARGET 1</div><div class="v" id="t1">â€”</div></div>
  <div class="kpi"><div class="t">TARGET 2</div><div class="v" id="t2">â€”</div></div>
</div>
...
<div class="row3">
<div><div class="small">RSI 14</div><b id="rsi">â€”</b></div>
<div><div class="small">EMA 9</div><b id="ema9">â€”</b></div>
<div><div class="small">EMA 21</div><b id="ema21">â€”</b></div>
<div><div class="small">ATR 14</div><b id="atr">â€”</b></div>
<div><div class="small">Bull Score</div><b id="bullScore">â€”</b></div>
<div><div class="small">Bear Score</div><b id="bearScore">â€”</b></div>
</div>
</div>
...
const fmt=x=>(x==null||!Number.isFinite(Number(x)))?"â€”":Number(x).toLocaleString("en-IN",{minimumFractionDigits:2,maximumFractionDigits:2});
let running=false;
...
function put(d){
  ...
  $("bias").textContent=`${d.bias} â€¢ ${Math.max(d.bull_score,d.bear_score)}/4 conditions`;
  ...
  $("status").textContent="Connected â€¢ server feed";
