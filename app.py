...
<meta name="theme-color" content="#07111f"><title>NIFTY Professional V2.5</title>
<style>
...
<h1>📈 NIFTY Professional Signals V2.5</h1><div class="sub">5m + 15m confirmation • confidence scoring • option liquidity • trade alerts</div>
...
function readTrade(){try{return JSON.parse(localStorage.getItem("niftyV25Trade")||"null")}catch(e){return null}}
function saveTrade(t){localStorage.setItem("niftyV25Trade",JSON.stringify(t))}
function clearTrade(){localStorage.removeItem("niftyV25Trade");updateTradeUI(null)}
...
$("dot").className="dot on";$("status").textContent="Connected • V2.5";$("error").textContent=d.warning||"";monitorTrade(d);updateTradeUI(readTrade())}
