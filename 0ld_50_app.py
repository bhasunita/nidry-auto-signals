...
def health():
    return jsonify({"ok": True, "version": "3.6"})
...
<meta name="theme-color" content="#07111f"><title>NIFTY Professional V3.6</title>
<style>
...
<h1>ðŸ“ˆ NIFTY Professional Signals V3.6</h1><div class="sub">5m + 15m confirmation â€¢ confidence scoring â€¢ option liquidity â€¢ trade alerts</div>
...
<div class="card"><div class="status"><span id="dot" class="dot"></span><span id="status">Startingâ€¦</span><span id="marketStatus" style="margin-left:auto">â€”</span></div>
<div class="price" id="spot">â€”</div><div id="signal" class="signal neutral">WAITING</div><div class="small" id="bias">Loading market dataâ€¦</div><div class="small" id="updated">â€”</div><div id="error"></div></div>
...
<div class="card"><div class="small" id="marketViewTitle">Current market view</div><div id="marketViewSignal" style="font-size:18px;font-weight:850;margin-top:3px">â€”</div><div class="small">Signal confidence</div><div id="confidence" style="font-size:28px;font-weight:900">â€”</div><div class="progress"><div class="bar" id="confBar"></div></div><div class="small" id="reason">â€”</div></div>

<div class="card" id="qualityCard">
<div class="small">V3.6 PROFESSIONAL ENTRY QUALITY ENGINE</div>
<div id="qualityGrade" style="font-size:26px;font-weight:900;margin-top:4px">â€”</div>
<div id="qualityState" style="font-size:18px;font-weight:850;margin-top:4px">WAIT</div>
<div class="small" id="qualitySummary">Waiting for market dataâ€¦</div>
<div class="small" id="regimeDetail" style="margin-top:4px">Market regime: â€”</div>
<div style="height:8px"></div>
<div id="qualityChecks"></div>
</div>

<div class="card"><div class="small" id="optionCardTitle">Automatically selected option</div><div id="contract" class="contract">â€”</div><div class="small" id="expiry">â€”</div><div class="small" id="liquidity">â€”</div><div style="height:10px"></div>
<div class="row3"><div class="kpi"><div class="t">OPTION LTP</div><div class="v" id="optionLtp">â€”</div></div><div class="kpi"><div class="t">BID</div><div class="v" id="bid">â€”</div></div><div class="kpi"><div class="t">ASK / ENTRY</div><div class="v" id="ask">â€”</div></div></div></div>

<div class="row"><div class="kpi"><div class="t">ENTRY</div><div class="v" id="entry">â€”</div></div><div class="kpi"><div class="t">STOP LOSS</div><div class="v" id="sl">â€”</div></div></div>
<div style="height:8px"></div><div class="row"><div class="kpi"><div class="t">TARGET 1</div><div class="v" id="t1">â€”</div></div><div class="kpi"><div class="t">TARGET 2 / EXIT</div><div class="v" id="t2">â€”</div></div></div>
...
<div class="small" style="margin-top:8px">Warning only â€” this does not automatically close or modify your locked trade.</div>
</div>

<div class="card" id="tradeHealthCard"><div class="small">V3.6 PROFESSIONAL TRADE HEALTH</div>
...
<div class="small">V3.6 END-OF-DAY POSITION DECISION</div>
<div id="eodDecision" style="font-size:25px;font-weight:900;margin-top:4px">NO ACTIVE POSITION</div>
<div id="eodScore" class="small" style="margin-top:4px">Carry score â€” / 100</div>
...
<div id="eodWindow" class="small" style="margin-top:7px">Review window: 3:05 PM onward (India time).</div>
</div>

<div class="card"><div class="small">V3.6 SESSION TRADE JOURNAL</div>
<div class="row"><div class="kpi"><div class="t">EVENTS</div><div class="v" id="journalCount">0</div></div><div class="kpi"><div class="t">LAST EVENT</div><div class="v" id="journalLast" style="font-size:14px">â€”</div></div></div>
...
<div class="row"><div class="kpi"><div class="t">LIVE P/L</div><div class="v" id="livePnl">â€”</div></div><div class="kpi"><div class="t">CURRENT LTP</div><div class="v" id="liveTradeLtp">â€”</div></div></div>
<div style="height:8px"></div>
<div class="row"><div class="kpi"><div class="t">TO STOP LOSS</div><div class="v" id="distSl">â€”</div></div><div class="kpi"><div class="t">TO TARGET 1</div><div class="v" id="distT1">â€”</div></div></div>
<div style="height:8px"></div>
<div class="row"><div class="kpi"><div class="t">TO TARGET 2</div><div class="v" id="distT2">â€”</div></div><div class="kpi"><div class="t">RISK / REWARD</div><div class="v" id="rrNow">â€”</div></div></div>
...
<div><div class="small">Rating 5m</div><b id="rating5">â€”</b></div><div><div class="small">Rating 15m</div><b id="rating15">â€”</b></div>
<div><div class="small">RSI 5m</div><b id="rsi5">â€”</b></div><div><div class="small">RSI 15m</div><b id="rsi15">â€”</b></div>
<div><div class="small">EMA 10/20 5m</div><b id="ema5">â€”</b></div><div><div class="small">EMA 10/20 15m</div><b id="ema15">â€”</b></div>
<div><div class="small">MACD 5m</div><b id="macd5">â€”</b></div><div><div class="small">ADX 5m</div><b id="adx5">â€”</b></div>
<div><div class="small">ATR 5m</div><b id="atr5">â€”</b></div>
<div><div class="small">ADX 15m</div><b id="adx15">â€”</b></div>
<div><div class="small">VWAP 5m</div><b id="vwap5">â€”</b></div>
<div><div class="small">EMA 50 5m</div><b id="ema50_5">â€”</b></div>
<div><div class="small">EMA 50 15m</div><b id="ema50_15">â€”</b></div>
<div><div class="small">MACD 15m</div><b id="macd15">â€”</b></div>
</div><div style="height:10px"></div><div id="checks"></div></div>

<div class="card"><div class="small" id="triggerSectionTitle" style="margin-bottom:8px">Current scanner trigger levels</div><div class="row"><div class="kpi"><div class="t">NIFTY BUY ABOVE</div><div class="v" id="buyAbove">â€”</div></div><div class="kpi"><div class="t">NIFTY SELL BELOW</div><div class="v" id="sellBelow">â€”</div></div></div></div>
<button id="refresh">REFRESH NOW</button></div>

<script>
"use strict";const $=id=>document.getElementById(id);const fmt=x=>(x==null||!Number.isFinite(Number(x)))?"â€”":Number(x).toLocaleString("en-IN",{minimumFractionDigits:2,maximumFractionDigits:2});let busy=false;
let reconnectFailures=0;
let reconnectTimer=null;
let lastSignalData=null;
const LAST_SIGNAL_KEY="niftyV36LastSignal";

function saveLastSignal(d){
 try{
   lastSignalData=d;
   localStorage.setItem(LAST_SIGNAL_KEY,JSON.stringify({savedAt:Date.now(),data:d}));
 }catch(e){}
}
function loadLastSignal(){
 try{
   const x=JSON.parse(localStorage.getItem(LAST_SIGNAL_KEY)||"null");
   if(x&&x.data){lastSignalData=x.data;return x}
 }catch(e){}
 return null
}
function showConnectionIssue(msg,nextSeconds=null){
 ...
 $("connectionDetail").textContent=
   `Showing last known data. ${msg||"Temporary server/network problem."}`+
   (nextSeconds!==null?` Retrying in ${nextSeconds}s.`:"");
 $("dot").className="dot warn";
 $("status").textContent="Reconnecting â€¢ V3.5";
}
 ...
 for(let i=0;i<attempts;i++){
   ...
   try{
     ...
     if(ct.includes("application/json")) body=await r.json();
       ...
       throw new Error(`HTTP ${r.status}${raw?" â€¢ non-JSON response":""}`);
     }
...
function evaluateReversalWarning(t,d){
 ...
 const lockedSide=String(t.type||"").toUpperCase()==="PE"?"SELL":"BUY";
 ...
 if(prior!==key){
   ...
   notify("âš ï¸ MARKET REVERSAL / EXIT WARNING",
...
function updateTradeUI(t){
 ...
 if(!t){
   hideReversalWarning();
   if(title)title.textContent="Automatically selected option";
   $("tradeState").textContent="NO ACTIVE TRADE";
   $("tradeDetail").textContent="Alerts work while this page stays open.";
   $("livePnl").textContent="â€”"; $("liveTradeLtp").textContent="â€”";
   $("distSl").textContent="â€”"; $("distT1").textContent="â€”"; $("distT2").textContent="â€”";
   $("rrNow").textContent="â€”"; $("tradeProgressText").textContent="No locked trade.";
   return
 }
 ...
 const pnl=(cp>0&&entry>0)?((cp-entry)/entry)*100:null;
 const cpText=cp>0?` â€¢ Current â‚¹${fmt(cp)}`:"";
 const pnlText=pnl!==null?` â€¢ Ref P/L ${pnl>=0?"+":""}${pnl.toFixed(1)}%`:"";
 $("tradeDetail").textContent=`${t.contract} â€¢ Locked Entry â‚¹${fmt(entry)}${cpText}${pnlText} â€¢ SL â‚¹${fmt(sl)} â€¢ T1 â‚¹${fmt(t1)} â€¢ T2 â‚¹${fmt(t2)}`;
 $("liveTradeLtp").textContent=cp>0?`â‚¹${fmt(cp)}`:"â€”";
 $("livePnl").textContent=pnl!==null?`${pnl>=0?"+":""}${pnl.toFixed(1)}%`:"â€”";
 const dsl=(cp>0&&sl>0)?((cp-sl)/cp*100):null;
 const dt1=(cp>0&&t1>0)?((t1-cp)/cp*100):null;
 const dt2=(cp>0&&t2>0)?((t2-cp)/cp*100):null;
 $("distSl").textContent=dsl!==null?`${dsl.toFixed(1)}%`:"â€”";
 $("distT1").textContent=dt1!==null?`${dt1.toFixed(1)}%`:"â€”";
 $("distT2").textContent=dt2!==null?`${dt2.toFixed(1)}%`:"â€”";
 const risk=(entry>0&&sl>0)?(entry-sl):0, reward=(entry>0&&t1>0)?(t1-entry):0;
 $("rrNow").textContent=(risk>0&&reward>0)?`1:${(reward/risk).toFixed(2)}`:"â€”";
...
function renderLockedTrade(t,q=null){
 ...
 $("bias").textContent=isClosedTrade(t)?"LOCKED TRADE COMPLETE â€¢ RESET TO SCAN AGAIN":"LOCKED TRADE â€¢ LIVE P/L + SL/TARGET MONITORING â€¢ V3.6 QUALITY + REVERSAL + EOD CHECKS ACTIVE";
 $("contract").textContent=t.contract;
 $("contract").className="contract "+(t.type==="PE"?"sell":"buy");
 $("expiry").textContent=`Locked ${t.expiry||""} â€¢ Strike ${t.strike||""} â€¢ ${t.type||""}`;
 $("liquidity").textContent=q
   ?`LOCKED CONTRACT â€¢ ${q.stale?"STALE/FALLBACK":"LIVE"} â€¢ Volume ${q.volume||0} â€¢ OI ${q.oi||0} â€¢ BidQty ${q.bid_qty||0} â€¢ AskQty ${q.ask_qty||0}${q.spread_pct!=null?` â€¢ Spread ${fmt(q.spread_pct)}%`:""}${q.quote_time?` â€¢ ${q.quote_time}`:""}`
   :"LOCKED CONTRACT â€¢ waiting for live quote";
 const ltp=q&&Number(q.ltp)>0?Number(q.ltp):Number(t.currentLtp||0);
 $("optionLtp").textContent=ltp>0?"â‚¹"+fmt(ltp):"â€”";
 $("bid").textContent=q&&Number(q.bid)>0?"â‚¹"+fmt(q.bid):"â€”";
 $("ask").textContent=q&&Number(q.ask)>0?"â‚¹"+fmt(q.ask):"â€”";
 $("entry").textContent="â‚¹"+fmt(t.entry);
 $("sl").textContent="â‚¹"+fmt(t.sl);
 $("t1").textContent="â‚¹"+fmt(t.t1);
 $("t2").textContent="â‚¹"+fmt(t.t2);
}
...
function addJournal(kind,t,detail=""){
 const j=journal(); j.unshift({time:new Date().toLocaleString(),kind,contract:t&&t.contract?t.contract:"â€”",detail});
 localStorage.setItem("niftyV36Journal",JSON.stringify(j.slice(0,50))); renderJournal();
}
function renderJournal(){const j=journal();$("journalCount").textContent=j.length;$("journalLast").textContent=j.length?`${j[0].kind} â€¢ ${j[0].time}`:"â€”"}
function evaluateTradeHealth(t,d){
 ...
 if(score<35 || pnl<=-15){label="EXIT REVIEW";action="SETUP INVALIDATION RISK â€” review broker position and stop immediately";color="#ff7690"}
 else if(score<55){label="WEAKENING";action="DEFENSIVE MODE â€” avoid adding; consider tighter risk";color="#ef4444"}
 else if(score<75){label="CAUTION";action="MONITOR CLOSELY â€” momentum is mixed";color="#f59e0b"}
 $("tradeHealth").textContent=`${label} â€¢ ${Math.max(0,Math.min(100,score))}/100`;$("tradeHealth").style.color=color;
 $("tradeAction").textContent=action;$("tradeHealthReasons").textContent=reasons.length?reasons.slice(0,4).join(" â€¢ "):"Current trend structure remains aligned with the locked trade.";
 if((label==="EXIT REVIEW"||label==="WEAKENING")&&t.lastHealthAlert!==label){t.lastHealthAlert=label;saveTrade(t);notify("âš ï¸ TRADE "+label,`${t.contract} â€¢ ${action}`,"stop");addJournal(label,t,action)}
}
...
function evaluateEodDecision(t,d){
 ...
 if(!t || isClosedTrade(t)){
   dec.textContent=t?"POSITION CLOSED":"NO ACTIVE POSITION";dec.style.color="#cbd5e1";scoreEl.textContent="Carry score â€” / 100";act.textContent=t?"No overnight decision required.":"Waiting for a locked trade.";why.textContent="Final carry/exit review becomes active only for an open locked trade.";return;
 }
 const bull=t.type==="CE"; let score=0, reasons=[], positives=[];
 const dir15=bull?["BUY","STRONG BUY"].includes(d.rating15):["SELL","STRONG SELL"].includes(d.rating15);
 const ema15=bull?d.ema10_15>d.ema20_15:d.ema10_15<d.ema20_15;
 ...
 act.textContent=action;why.textContent=(reasons.length?reasons.slice(0,5):positives.slice(0,5)).join(" â€¢ ") || "No additional EOD evidence available.";
 win.textContent=review?(finalWindow?"FINAL EOD REVIEW WINDOW ACTIVE â€¢ India time":"EOD REVIEW ACTIVE â€¢ final check again after 3:20 PM"):`Review window starts at 3:05 PM India time â€¢ current score is provisional.`;
 if(review && t.lastEodDecision!==label){t.lastEodDecision=label;saveTrade(t);notify("ðŸŒ™ EOD: "+label,`${t.contract} â€¢ Carry score ${score}/100 â€¢ ${action}`,label.includes("EXIT")?"stop":"entry");addJournal("EOD "+label,t,`Carry score ${score}/100`)}
}
...
function applyTradePrice(t,p){
 ...
 if((t.state==="ENTRY LOCKED / MONITORING"||t.state==="TARGET 1 HIT") && p<=effectiveSl){
   ...
   notify("ðŸ›‘ STOP / TRAIL HIT",`${t.contract} â€¢ LTP â‚¹${fmt(p)} â€¢ Effective SL â‚¹${fmt(effectiveSl)}`,"stop");
   addJournal("STOP / TRAIL HIT",t,`Exit reference â‚¹${fmt(p)}`);
 }
 else if((t.state==="ENTRY LOCKED / MONITORING"||t.state==="TARGET 1 HIT") && p>=t.t2){
   t.state="TARGET 2 HIT / CLOSED";
   notify("ðŸ† TARGET 2 HIT",`${t.contract} â€¢ LTP â‚¹${fmt(p)} â€¢ Locked final target â‚¹${fmt(t.t2)}`,"target2");
   addJournal("TARGET 2",t,`LTP â‚¹${fmt(p)}`);
 }
 else if(t.state==="ENTRY LOCKED / MONITORING" && p>=t.t1){
   t.state="TARGET 1 HIT";
   t.trailingSl=Math.max(Number(t.entry),Number(t.sl));
   notify("âœ… TARGET 1 HIT",`${t.contract} â€¢ LTP â‚¹${fmt(p)} â€¢ T1 â‚¹${fmt(t.t1)} â€¢ protective trail moved to â‚¹${fmt(t.trailingSl)}`,"target1");
   addJournal("TARGET 1",t,`Trail â‚¹${fmt(t.trailingSl)}`);
 }
 saveTrade(t);
 return t;
}
...
async function refreshLockedTrade(){
 ...
 try{
   ...
   if(q.stale){
     $("error").textContent="Locked trade using last good NSE quote temporarily.";
     showConnectionIssue("Locked-option live quote is temporarily stale.");
   }
 }catch(e){
   updateTradeUI(t);
...
function monitorTrade(d){
 ...
 notify("âœ… ENTRY REFERENCE LOCKED",`${t.contract} â€¢ Entry ref â‚¹${fmt(t.entry)} â€¢ SL â‚¹${fmt(t.sl)} â€¢ T1 â‚¹${fmt(t.t1)} â€¢ T2 â‚¹${fmt(t.t2)} â€¢ monitoring started`,"entry");
 addJournal("ENTRY LOCKED",t,`Entry â‚¹${fmt(t.entry)} â€¢ SL â‚¹${fmt(t.sl)} â€¢ T1 â‚¹${fmt(t.t1)} â€¢ T2 â‚¹${fmt(t.t2)}`);
...
function render(d){
 ...
 $("updated").textContent=`Updated ${d.updated} â€¢ ${d.data_source}`;
 ...
 $("marketViewSignal").textContent=`${d.signal} â€¢ 5m ${d.rating5} â€¢ 15m ${d.rating15}`;
 ...
 $("checks").innerHTML=d.checks.map(x=>`<span class="pill ${x.ok?"ok":"bad"}">${x.ok?"âœ“":"âœ•"} ${x.label}</span>`).join("");
 const qGrade=d.quality_grade||"â€”";
 $("qualityGrade").textContent=qGrade==="A+"?"GRADE A+ â€¢ PREMIUM SETUP":qGrade==="A"?"GRADE A â€¢ CONFIRMED SETUP":qGrade==="B"?"GRADE B â€¢ PREPARE ONLY":qGrade==="C"?"GRADE C â€¢ WAIT":"NO NEW ENTRY";
 ...
 $("regimeDetail").textContent=`Market regime: ${d.market_regime||"â€”"}${d.candle_confirmation?" â€¢ candle aligned":""}${d.breakout_confirmation?" â€¢ breakout confirmed":""}`;
 $("qualityChecks").innerHTML=(d.quality_checks||[]).map(x=>`<span class="pill ${x.ok?"ok":"bad"}">${x.ok?"âœ“":"âœ•"} ${x.label}</span>`).join("");
 $("dot").className="dot on";$("status").textContent="Connected â€¢ V3.6";$("error").textContent=d.warning||"";
 saveLastSignal(d);
 ...
 if(t){
   ...
   $("marketViewTitle").textContent="CURRENT MARKET VIEW â€” informational only";
   $("indicatorSectionTitle").textContent="CURRENT MARKET INDICATORS â€” do not overwrite locked trade";
   $("triggerSectionTitle").textContent="CURRENT SCANNER LEVELS â€” next setup only";
   renderLockedTrade(t,null);
 ...
 if(d.option){
   ...
   $("expiry").textContent=`Expiry ${d.option.expiry} â€¢ Strike ${d.option.strike} â€¢ ${d.option.type}`;
   $("liquidity").textContent=`Liquidity ${d.option.liquidity} â€¢ Volume ${d.option.volume} â€¢ OI ${d.option.oi} â€¢ BidQty ${d.option.bid_qty||0} â€¢ AskQty ${d.option.ask_qty||0} â€¢ Spread ${fmt(d.option.spread_pct)}% â€¢ Risk ${fmt(d.option.risk_pct||0)}% â€¢ R:R ${fmt(d.option.rr1||0)} / ${fmt(d.option.rr2||0)}`;
   $("optionLtp").textContent="â‚¹"+fmt(d.option.ltp);$("bid").textContent="â‚¹"+fmt(d.option.bid);$("ask").textContent="â‚¹"+fmt(d.option.ask);
   $("entry").textContent="â‚¹"+fmt(d.option.entry);$("sl").textContent="â‚¹"+fmt(d.option.sl);$("t1").textContent="â‚¹"+fmt(d.option.target1);$("t2").textContent="â‚¹"+fmt(d.option.target2)
 }else{
   ["contract","expiry","liquidity","optionLtp","bid","ask","entry","sl","t1","t2"].forEach(id=>$(id).textContent="â€”")
 }
 monitorTrade(d);
...
async function refresh(){
 ...
 try{
   const d=await fetchJsonWithRetry("/api/signal",3,10000);
   render(d);
 }catch(e){
   reconnectFailures++;
   const cached=loadLastSignal();
   if(cached&&cached.data){
     // Re-render cached scanner data, but never touch the locked trade values.
     render(cached.data);
     const ageMin=Math.max(0,Math.round((Date.now()-Number(cached.savedAt||Date.now()))/60000));
     $("updated").textContent=`LAST KNOWN DATA â€¢ saved about ${ageMin} min ago`;
   }
   const delay=Math.min(60,5*Math.pow(2,Math.min(reconnectFailures-1,3)));
   $("error").textContent="Live refresh failed: "+e.message;
   showConnectionIssue("Server/network unavailable.",delay);
...
window.addEventListener("online",()=>{showConnectionIssue("Internet restored. Reconnecting nowâ€¦");refresh();refreshLockedTrade()});
...
if(cachedStartup&&cachedStartup.data){
 try{
   ...
   $("updated").textContent="LAST KNOWN DATA â€¢ checking live connectionâ€¦";
...
def score(tv,bull=True):
    ...
    add("ADX 5m â‰¥ 20",tv["adx5"]>=20,3)
    add("ADX 15m â‰¥ 18",tv["adx15"]>=18,2)
    return s,checks
...
def build_signal():
    ...
    if strong_gate and conf>=80 and diff>=20:
        ...
        raw_signal="NO TRADE"
        bias="FILTERED OUT â€¢ CONDITIONS NOT STRONG ENOUGH"
    ...
    if strong:
        ...
        if execution_ready:
            signal=direction
            bias=("BULLISH" if bull else "BEARISH")+" â€¢ FROZEN TRIGGER CONFIRMED 2/2"
        else:
            ...
            bias=("BULLISH WATCH" if bull else "BEARISH WATCH")+" â€¢ WAITING FOR "+(" + ".join(waiting) if waiting else "CONFIRMATION")
    elif raw_signal in ("BUY WATCH","SELL WATCH"):
        # Watch-stage setup keeps the same frozen breakout level.
        signal=raw_signal
        bias=("BULLISH WATCH" if bull else "BEARISH WATCH")+f" â€¢ FROZEN TRIGGER {confirm_count}/2"
    else:
    ...
    return {
        ...
        "reason":f"{conf}/100 â€¢ 5m {tv_rating(tv['rec5'])} â€¢ 15m {tv_rating(tv['rec15'])} â€¢ ADX 5m {tv['adx5']:.1f} / 15m {tv['adx15']:.1f} â€¢ Quality {quality_passed}/{len(quality_checks)} â€¢ {entry_state} â€¢ {market_regime} â€¢ Trigger {confirm_count}/2 â€¢ {trigger_note}",
        ...
        "option":opt,"execution_ready":execution_ready,
