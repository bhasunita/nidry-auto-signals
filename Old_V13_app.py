...
def health():
    return jsonify({"ok": True, "version": "2.7-public"})
...
<meta name="theme-color" content="#07111f"><title>NIFTY Professional V2.7 Public</title>
<style>
...
<h1>📈 NIFTY Professional Signals V2.7 Public</h1><div class="sub">5m + 15m confirmation • confidence scoring • option liquidity • trade alerts</div>
...
function render(d){
 ...
 $("dot").className="dot on";$("status").textContent="Connected • V2.7 Public";$("error").textContent=d.warning||"";
